...
if ($val->num_rows > 0) {
    while (list($id, $name, $price, $dis, $img) = mysqli_fetch_array($val)) {
        ...
        echo "<td>".$price."</td>";
        echo "<td>".$dis."</td>";
        echo "<td><img src='./img/$img' height='100' width='100' style='border-radius:20px;' /></td>";
        echo "<td><a href='delete-food.php?id=$id&img=$img'><img src='img/deletef.webp' style='border-radius:20px; margin-left:-20px' width='80'/></a></td>";
        echo "<td><a href='edit-food.php?id=$id'><img src='img/editf.webp' style='border-radius:20px; margin-left:-20px' width='80'/></a></td>";
        echo "</tr>";
    }
} else {
